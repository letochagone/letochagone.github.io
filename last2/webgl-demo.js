...
function animate(timestamp) {
   ...
   // gl_Traitement.viewport(0, 0, 640, 480);
    ...
    gl_Traitement.disable(gl_Traitement.BLEND);
    gl_Traitement.clearColor(1,1,0,1);
   ...
   // gl_Traitement.drawArrays(gl_Traitement.POINTS, 0, 1); // delete
    ...
    gl.bindFramebuffer(gl.FRAMEBUFFER, null); // delete uncomment
   //gl.bindTexture(gl_Traitement.TEXTURE_2D, pixT0); //delete comment
   ...
   // gl.clearColor(fond.r / 255, fond.v / 255, fond.b / 255, fond.a / 255);
    ...
    // pixels2 = new Float32Array(4 * 1 * 1); // delete comment
 // gl.readPixels(0, 0, 1, 1, gl.RGBA, gl.FLOAT, pixels2); // delete comment
