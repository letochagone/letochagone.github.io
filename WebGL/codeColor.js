...
let strReg1 = /"(.*?)"/g,
    strReg2 = /'(.*?)'/g,
    specialReg = /\b(new|let|if|do|function|while|switch|for|foreach|in|continue|break)(?=[^\w])/g,
...
let codeElements = document.getElementsByClassName("colorJavascript");
...
let elements = document.getElementsByClassName("colorJavascript");
//w3CodeColor(elements[0],"js");
//w3CodeColor(elements[1],"js");
...
function w3CodeColor(elmnt, mode) {
  ...
  function extract(str, start, end, func, repl) {
    //    comment = new extract(str, /\/\*/, "*/", commentMode, "W3CSSCOMMENTPOS");
