...
;hljs.registerLanguage("ruby",e)})();/*! `glsl` grammar compiled for Highlight.js 11.7.0 */
...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `swift` grammar compiled for Highlight.js 11.7.0 */
